package com.jinggan.library.ui.widget.bottomnavigation;
...
import com.jinggan.library.ui.widget.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.jinggan.library.ui.widget.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.jinggan.library.ui.widget.bottomnavigation.utils.Utils;
...
//    }
     ...
     * version: V1.0
     * created at 2017/3/14 22:33
     * <p>
     * Copyright (c) 2017 Shenzhen O&M Cloud Co., Ltd. All rights reserved.
     */
    public BottomNavigationBar setActiveColorV2(int activeColor) {
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mMode == MODE_FIXED) {
                ...
                int[] widths = BottomNavigationHelper.getMeasurementsForFixedMode(getContext(), screenWidth, mBottomNavigationItems.size() + addIconTotal, mScrollable);
                ...
                int[] widths = BottomNavigationHelper.getMeasurementsForShiftingMode(getContext(), screenWidth, mBottomNavigationItems.size() + addIconTotal, mScrollable);
     ...
     * <p>
     * author: hezhiWu
     * created at 2017/4/18 18:01
     *
     * @param position
     */
    public void addRecordImageView(int position, OnTabMenuClickListener listener) {
        addIconTotal++;
        menuView = LayoutInflater.from(getContext()).inflate(R.layout.main_bottom_add, null);
        floatingActionButton = (FloatingActionButton) menuView.findViewById(R.id.Wayto_main_bottom_floatButton);
...
//                    }
        ...
        initialise();
        mTabContainer.addView(menuView, position);
    }
    ...
    private void openMenu(View view) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(view, "rotation", 0F, 80F);
        animator.setDuration(200);
        animator.start();
    }

    private void closeMenu(View view) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(view, "rotation", 80F, 0F);
        animator.setDuration(200);
        animator.start();
    }
