...
//        dialog.setTitleTextVisibility(View.GONE);
     ...
     * @return
     */
    public static ProgressDialog createLoadingDialog(Activity context, String msg,
...
//        showDialog(dialog);
     ...
     * @return
     */
    public static ProgressDialog createLoadingDialog(Activity context, int msgRes,
                                             boolean backPressCancel) {
        if (context == null) {
            return null;
        }
...
//        showDialog(dialog);
        ProgressDialog dialog= ProgressDialog.show(context,"",context.getResources().getString(msgRes));
        return dialog;
    }
     ...
     * @return
     */
    public static ProgressDialog createLoadingDialog(Activity context) {
        return createLoadingDialog(context, "加载...");
    }
